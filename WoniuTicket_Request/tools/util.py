...
class Utility:
    ...
    @classmethod
    def get_url_head(cls, uri):
        url_path = Utility.get_json(Utility.get_root_path() + "\\conf\\Base_conf\\base.conf")[0]
    ...
    def initialize_DB(cls):
        path = 'D:\\python\\pycharmProject\\WoniuTicket_Request\\wts.sql'
        import os
...
if __name__ == '__main__':
    login_info = Utility.get_json(Utility.get_root_path() + "\\conf\Excel_conf\\a_MPM.conf")[0]
    print(login_info)
